...
public class PortfolioWorkUpdateResponse {
    ...
    public PortfolioWorkUpdateResponse(boolean done, int code, String msg, Data data) {
        this.done = done;
        this.code = code;
        this.msg = msg;
        this.data = data;
    ...
    @Override
    public String toString() {
        return "PortfolioWorkUpdateResponse{" +
                "done=" + done +
                ", code=" + code +
                ", msg='" + msg + '\'' +
                ", data=" + data +
